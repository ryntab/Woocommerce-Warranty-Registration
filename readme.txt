...
Installing "Woo Wizard Product Registration" can be done either by searching for "Woo Wizard Product Registration" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
